...
<style>
    ...
    .core-idea-box {
        ...
        box-shadow: 0 2px 12px rgba(245, 230, 211, 0.2);
    }
    ...
    /* ===== 修复乱码 ===== */
    .core-idea-text, .body-text, .question-text {
...
<div class="book-card" style="opacity: 0.6; cursor: not-allowed;">
    ...
    <div style="margin-top: 0.75rem; color: #636E72; font-size: 0.85rem; font-style: italic;">即将推出</div>
</div>
""", unsafe_allow_html=True)
...
def render_sidebar():
    ...
    with st.sidebar:
        # Logo区域 - 优雅设计，使用思考图标
        st.markdown("""
<div style="text-align: center; padding: 2.5rem 0 1.5rem 0; border-bottom: 2px solid #E8EEF2; background: linear-gradient(180deg, #FAFBFC 0%, #FFFFFF 100%);">
    <div style="font-size: 3.5rem; margin-bottom: 0.75rem; text-shadow: 0 2px 8px rgba(0,0,0,0.08);">💭</div>
...
""", unsafe_allow_html=True)
            ...
            for key, label in sections:
                ...
                if is_current:
                    st.markdown(f"""
<div style="background: #2D3436; color: #FFFFFF; padding: 0.65rem 0.875rem; border-radius: 6px; margin-bottom: 0.5rem; font-size: 0.85rem;">
    {label}
</div>
""", unsafe_allow_html=True)
                else:
...
<div style="margin-top: auto; padding-top: 2rem; text-align: center; border-top: 2px solid #E8EEF2;">
    <div style="font-size: 0.7rem; color: #636E72; line-height: 1.8;">
        给自己时间<br/>慢慢来<br/><br/>🌱
    </div>
</div>
""", unsafe_allow_html=True)
