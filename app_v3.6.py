...
<div style="text-align: center; padding: 2rem 0 1.5rem 0;">
    <svg width="80" height="80" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="margin: 0 auto 0.75rem auto;">
        <!-- 脑子轮廓 - 黑色线条 -->
        <path d="M30 40
                 C 20 40, 15 50, 15 60
                 C 15 75, 25 85, 40 85
        ...
        <!-- 脑回 - 左侧 -->
        <path d="M30 45 Q 25 55, 30 65" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>
        <path d="M28 50 Q 23 60, 28 70" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>

        <!-- 脑回 - 右侧 -->
        <path d="M70 45 Q 75 55, 70 65" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>
        <path d="M72 50 Q 77 60, 72 70" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>

        <!-- 脑回 - 中间 -->
        <path d="M45 30 Q 50 40, 45 50" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>
        <path d="M55 30 Q 60 40, 55 50" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>

        <!-- 脑沟 -->
        <path d="M35 55 Q 50 65, 65 55" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>
        <path d="M38 62 Q 50 70, 62 62" fill="none" stroke="#2D3436" stroke-width="1.5" stroke-linecap="round"/>
    </svg>
